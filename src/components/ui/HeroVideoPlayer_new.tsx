      ...
      <div className={`absolute inset-0 z-20 flex flex-col justify-center px-4 sm:px-6 lg:px-16 transition-opacity duration-1000 ${
        ...
        <div className="max-w-2xl">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-4 mb-4 sm:mb-8">
            ...
            {/* Add to Watchlist Button - Hidden on small mobile */}
            <button
              ...
              className={`items-center space-x-2 bg-transparent border-2 border-white/40 hover:border-white/60 text-white font-semibold rounded-lg transition-all duration-300 ${
                isMobile ? 'hidden sm:flex px-3 py-2 text-sm' : 'flex px-6 py-2'
              }`}
            >
          ...
          {/* Video Controls - Show only when video is playing */}
          {showControls && showVideo && currentVideo && !isMobile && (
      ...
      {showVideo && (
        <div className="absolute top-8 right-8 z-30">
          <button
            ...
            className="p-3 bg-black/60 hover:bg-black/80 border border-white/20 rounded-full transition-all duration-300 text-white backdrop-blur-md"
          >
            <Pause size={20} />
          </button>
        </div>
