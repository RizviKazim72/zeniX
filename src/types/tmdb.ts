...
import { MediaVideo, MediaCredit } from './tmdb-types';
...
interface TmdbApi {
  ...
  movieVideos: (id: number) => Promise<{ results: MediaVideo[] }>;
  movieCredits: (id: number) => Promise<{ cast: MediaCredit[]; crew: MediaCredit[] }>;
  ...
  tvVideos: (id: number) => Promise<{ results: MediaVideo[] }>;
  tvCredits: (id: number) => Promise<{ cast: MediaCredit[]; crew: MediaCredit[] }>;
